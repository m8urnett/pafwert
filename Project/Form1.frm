...
Begin VB.Form Form1 
   ...
   Begin ExplorerBarCtl.ExplorerBar ExplorerBar1 
      ...
      HeaderImageItem1Picture=   "Form1.frx":0000
      ...
      HeaderImageItem2Picture=   "Form1.frx":0712
      ...
      HeaderImageItem3Picture=   "Form1.frx":0E24
      ...
      HeaderImageItem4Picture=   "Form1.frx":1536
      ...
      HeaderImageItem5Picture=   "Form1.frx":1C48
      ...
      HeaderImageItem6Picture=   "Form1.frx":235A
      ...
      HeaderImageItem7Picture=   "Form1.frx":2A6C
      ...
      HeaderImageItem8Picture=   "Form1.frx":317E
      ...
      HeaderImageItem9Picture=   "Form1.frx":3890
      ...
      HeaderImageItem10Picture=   "Form1.frx":3FA2
      ...
      HeaderImageItem11Picture=   "Form1.frx":46B4
      ...
      Begin FramePlusCtl.FramePlus fraOpt 
         ...
         EndProperty
         Caption         =   "FramePlus7"
         Begin FramePlusCtl.FramePlus FramePlus5 
            Height          =   735
            Left            =   60
            TabIndex        =   12
            Top             =   60
   ...
   Begin ExplorerBarCtl.ExplorerBar expPasses 
      ...
      GroupBackColor  =   14017506
      GroupBackColorAlt=   12506837
      BorderStyle     =   0
      BackColor       =   16777215
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Verdana"
      ...
      ImageItem1Picture=   "Form1.frx":4DC6
      HotStyleMousePointer=   99
      LicenceData     =   "Unlicensed"
   End
End
...
'Private Const BAR_WIDTH = 0 '3475
'
...
90    iQty = Val(txtQty)
  ...
  ' sPattern = "{{Word(adjective)+propercase} {word(noun)}+swap}"
...
End Sub
'
'Private Sub expPasses_SelChange(ByVal Group As ExplorerBarCtl.Group, ByVal Item As ExplorerBarCtl.GroupItem, ByVal SelectedObject As ExplorerBarCtl.ExplorerBarObjectTypeConstants)
'
'End Sub
...
'
'   For i = 0 To 3
'      optComplexity(i).BackColor = fraCharSets.BackColor
'   Next i
'
'   chkLower.BackColor = fraCharSets.BackColor
'   chkUpper.BackColor = fraCharSets.BackColor
'   chkNumbers.BackColor = fraCharSets.BackColor
'   chkSymbols.BackColor = fraCharSets.BackColor
...
Private Function CheckWordlistDir(Path As String) As Boolean
   ...
   If Len(Dir(Path)) Then
      If FileLen(Path & "\patterns.cfg") = 0 Or Err Then
         Err.Raise ERR_OPEN_PATTERNS_FILE, ERRSOURCE, ERR_OPEN_PATTERNS_FILE_DESC
      Else
         CheckWordlistDir = True
      End If
   End If
...
'         Dim sErrDescription As String
'
'         Const PROCNAME As String = "cmdAbout_Click"
'
'10       On Error GoTo ErrHandler
'20       frmAbout.Show vbModal, Me
'30       Exit Sub
'ExitHere:
'40       On Error Resume Next
'
'50       If lErrNumber <> 0 Then
'60          ShowUnexpectedError lErrNumber, sErrDescription, sErrSource
'70       End If
'80       Exit Sub
'ErrHandler:
'90       lErrNumber = Err.Number
'100      sErrDescription = Err.Description
'110      sErrSource = FormatErrorSource(Err.Source, MODULE_NAME, PROCNAME & " (" & Erl & ")")
'120      Resume ExitHere
'End Sub
'Private Sub slEntropy1_Change(ByVal NewValue As Long)
'End Sub

Private Sub FramePlus6_Click()
